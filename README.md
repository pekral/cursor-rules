...
- **32 comprehensive Agent skills** for automated workflows (v0.8.3)
...
> Current release includes 32 skills for issue resolution, code review, refactoring, testing, security, SQL performance, content writing, and delivery workflows.
