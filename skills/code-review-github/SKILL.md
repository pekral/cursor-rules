...
- If @.cursor/skills/mysql-problem-solver/SKILL.md reports SQL findings with severity **Critical** or **Moderate**, include all of them in the GitHub CR output/comment without downgrading or skipping.
