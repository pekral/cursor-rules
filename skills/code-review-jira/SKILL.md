...
#### JIRA (consolidated non-technical comment — one per CR run)
...
#### Linked GitHub issues (consolidated mirror — one per linked issue per CR run)
