...
- **SQL findings propagation:** When @.cursor/skills/mysql-problem-solver/SKILL.md reports SQL problems with severity **Critical** or **Moderate**, include all of them in the CR output. Do not omit or downgrade these findings.
