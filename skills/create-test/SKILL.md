...
- The generated code must comply with all rules defined for writing tests in @.claude/rules/php
/standards.mdc. If the project is written in Laravel, it must also comply with @.claude/rules/laravel/architecture.mdc.
