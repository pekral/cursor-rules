...
## Equivalent Tools by Framework

| Framework | CLI client |
|---|---|
| Laravel | `php artisan tinker` |
| Rails | `rails console` |
| Django | `python manage.py shell` |
| Node.js | `node` REPL or project-specific CLI |
...
- Do not expose raw CLI output in the final report — summarize the finding in plain language.
