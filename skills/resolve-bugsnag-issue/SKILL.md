...
description: "Resolves Bugsnag issues by fixing bugs, refactoring code, performing code and security reviews, ensuring 100% test coverage, running CI checks, and creating pull requests. Updates GitHub issues with review results. Use when the user provides a Bugsnag issue ID or link. Do not use for GitHub/JIRA issue resolution or merge-only workflows."
license: MIT
metadata:
...
2. Fetch the bug from Bugsnag (by issue ID or link). Use MCP to get all necessary information; load and analyze any other relevant resources.
...
12. After creating the PR, perform a code review per the code-review skill.
13. If not on the main git branch, switch to it.
